class Entry < ApplicationRecord
  ...
  def enqueue_instagram
    BufferJob.perform_later(self, { service: 'instagram', include_link: false, width: 1080, include_hashtags: true, include_body: true }) if self.is_published? && self.is_photo? && self.post_to_instagram
  end
