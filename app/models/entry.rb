...
class Entry < ApplicationRecord
  ...
  def threads_location_id
    ...
    return "1218801332248375" if self.locations.include?("Grand Teton National Park")
    return "5688310114545744" if self.locations.include?("Yellowstone National Park")
    return "997476204279232" if self.locations.include?("Mount Rainier National Park")
    return "1409771866175835" if self.locations.include?("Yosemite National Park")
    return "796830508349232" if self.locations.include?("Zion National Park")
    return "1686998451683036" if self.locations.include?("Grand Canyon National Park")
    return "788430943158887" if self.locations.include?("Glacier National Park")
    return "805973970760744" if self.locations.include?("National Elk Refuge")
    nil
  end

  def instagram_location_id
    return nil if ENV['ADD_LOCATIONS_TO_INSTAGRAM'].blank?
    return "130250293656242" if self.locations.include?("Grand Teton National Park")
    return "151418891540140" if self.locations.include?("Yellowstone National Park")
    return "275854322484638" if self.locations.include?("Mount Rainier National Park")
    return "138795446168746" if self.locations.include?("Yosemite National Park")
    return "143664062331242" if self.locations.include?("Zion National Park")
    return "131965493514224" if self.locations.include?("Grand Canyon National Park")
    return "74553624911" if self.locations.include?("Glacier National Park")
    nil
  end
